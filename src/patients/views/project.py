...
from ..serializers import (ProjectCohortSerializer, ProjectCreateSeralizer,
                           ProjectCrfTemplateSerializer,
                           ProjectCuratorSerializer, ProjectSeralizer)
from ...users.serializers import UserSerializer

from ..serializers.project import ProjectListSeralizer

class ProjectView(viewsets.GenericViewSet, ListModelViewMixin):
    """
