...
from ..models import ProjectCrfTemplate, CRFTemplate
...
class ProjectCrfTemplateSerializer(serializers.ModelSerializer):
    ...
    def delete_crf_templates(project_id, remove_crf_template_ids):
        ProjectCrfTemplate.objects.filter(
            project_id=project_id, crf_template_id__in=remove_crf_template_ids).delete()
