...
class MedicationRecord(BaseModel):
    ...
    discontinue_flag = models.CharField(max_length=settings.STRING_MAX_DEFAULT_LENGTH, null=True,)
    ...
    end_dttm = models.CharField(max_length=settings.STRING_MAX_DEFAULT_LENGTH, null=True,)
    ...
    def getMedicationRecordForEncounter(self, encounterid):
        query = '''SELECT * FROM {} WHERE encounter_id = '{}' '''.format('curation_medication_record', encounterid)
        logger.info('query: {}'.format(query))
        return MedicationRecord.objects.raw(query)
