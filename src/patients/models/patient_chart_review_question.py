...
class PatientChartReviewQuestion(BaseModel):
    ...
    patient_chart_review = models.ForeignKey(PatientChartReview, on_delete=models.CASCADE, related_name='questions_data')
    crf_template_question = models.ForeignKey(CRFTemplateQuestion, on_delete=models.CASCADE, related_name='question_responses')
